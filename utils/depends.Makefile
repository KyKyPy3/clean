...
bin/migrate: ARCHIVE := migrate.$(OSTYPE)-${ARCH2}.tar.gz
bin/migrate: bin
...
bin/gotestsum: ARCHIVE := gotestsum_$(VERSION)_$(OSTYPE)_${ARCH2}.tar.gz
bin/gotestsum: bin
...
bin/tparse: ARCHIVE := tparse_$(OSTYPE)_${ARCH1}
bin/tparse: bin
...
bin/mockery: ARCHIVE := mockery_$(VERSION)_$(OSTYPE)_${ARCH1}.tar.gz
bin/mockery: bin
...
bin/golangci-lint: ARCHIVE := golangci-lint-$(VERSION)-$(OSTYPE)-${ARCH2}.tar.gz
...
bin/go-arch-lint: ARCHIVE := go-arch-lint_$(VERSION)_$(OSTYPE)_${ARCH2}.tar.gz
...
bin/swag: ARCHIVE := swag_$(VERSION)_$(OSTYPE)_${ARCH1}.tar.gz
bin/swag: bin
