...
func (_m *UserRedisStorage) GetByID(ctx context.Context, id uuid.UUID) (entity.User, error) {
...
func (_c *UserRedisStorage_GetByID_Call) Run(run func(ctx context.Context, id uuid.UUID)) *UserRedisStorage_GetByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *UserRedisStorage_GetByID_Call) RunAndReturn(run func(context.Context, uuid.UUID) (entity.User, error)) *UserRedisStorage_GetByID_Call {
	_c.Call.Return(run)
	return _c
}
