...
func (_m *QueryHandler) Handle(_a0 context.Context, _a1 core.Query) (interface{}, error) {
...
func (_c *QueryHandler_Handle_Call) Return(_a0 interface{}, _a1 error) *QueryHandler_Handle_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *QueryHandler_Handle_Call) RunAndReturn(run func(context.Context, core.Query) (interface{}, error)) *QueryHandler_Handle_Call {
	_c.Call.Return(run)
	return _c
}
