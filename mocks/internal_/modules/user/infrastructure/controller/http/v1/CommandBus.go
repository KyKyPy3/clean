...
func (_m *CommandBus) Dispatch(_a0 context.Context, _a1 core.Command) error {
...
func (_c *CommandBus_Dispatch_Call) RunAndReturn(run func(context.Context, core.Command) error) *CommandBus_Dispatch_Call {
	_c.Call.Return(run)
	return _c
}
