...
func (_m *UserPgStorage) Delete(ctx context.Context, id common.UID) error {
...
func (_c *UserPgStorage_Delete_Call) Run(run func(ctx context.Context, id common.UID)) *UserPgStorage_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *UserPgStorage_Delete_Call) RunAndReturn(run func(context.Context, common.UID) error) *UserPgStorage_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *UserPgStorage) GetByEmail(ctx context.Context, email common.Email) (entity.User, error) {
...
func (_c *UserPgStorage_GetByEmail_Call) Run(run func(ctx context.Context, email common.Email)) *UserPgStorage_GetByEmail_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *UserPgStorage_GetByEmail_Call) RunAndReturn(run func(context.Context, common.Email) (entity.User, error)) *UserPgStorage_GetByEmail_Call {
	_c.Call.Return(run)
	return _c
}

// GetByID provides a mock function with given fields: ctx, id
func (_m *UserPgStorage) GetByID(ctx context.Context, id common.UID) (entity.User, error) {
	ret := _m.Called(ctx, id)
...
func (_c *UserPgStorage_GetByID_Call) Run(run func(ctx context.Context, id common.UID)) *UserPgStorage_GetByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(common.UID))
	})
	return _c
...
func (_c *UserPgStorage_GetByID_Call) RunAndReturn(run func(context.Context, common.UID) (entity.User, error)) *UserPgStorage_GetByID_Call {
	_c.Call.Return(run)
	return _c
}
